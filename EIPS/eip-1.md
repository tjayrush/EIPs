...
- Ecosystem Impact - A discussion of the impact of the EIP on the ecosystem as a whole (the commons). For example, if your proposal requires multiple smart contracts for each user, and the standard gets 10,000,000 users, how does that effect the ecosystem? Is the effect of your design sustainable as the use of your idea scales? This item aims to forestall standards whose success is detrimental to the common benefit.
